    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Data Mata Pelajaran</h5>
                        <hr>
                        <!-- Vertical Form -->
                        <form action="{{route('mapel.update', $mapel)}}" method="POST" class="row g-3">
                            @method('PUT')
                            @csrf
                            <div class="col-12">
                                <label for="inputNanme4" class="form-label">Nama Mata Pelajaran</label>
                                <input type="text" class="form-control" id="inputNanme4" name="nama_mapel" value="{{$mapel->nama_mapel ?? old('nama_mapel')}}">
                            </div>
