              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <a href="{{route('siswa.edit', $siswa)}}" class="btn btn-warning"><i class="bi bi-pencil"></i></a>
                    |
                    <a href="{{route('siswa.destroy', $siswa)}}" onclick="notificationBeforeDelete(event, this)" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                  </td>
                </tr>
                @endforeach
